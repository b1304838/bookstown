...
<html>
	<head>
		...
		<?php /* <link href="<?php echo e(asset('public/jtable/themes/redmond/jquery-ui-1.8.16.custom.css')); ?>" rel="stylesheet" type="text/css" /> */ ?>
	<?php /* <link href="<?php echo e(asset('public/jtable/scripts/jtable/themes/lightcolor/blue/jtable.css')); ?>" rel="stylesheet" type="text/css" /> */ ?>
	
	<?php /* <script src="<?php echo e(asset('public/jtable/scripts/jquery-1.6.4.min.js')); ?>" type="text/javascript"></script> */ ?>
    <?php /* <script src="<?php echo e(asset('public/jtable/scripts/jquery-ui-1.8.16.custom.min.js')); ?>" type="text/javascript"></script> */ ?>
    <?php /* <script src="<?php echo e(asset('public/jtable/scripts/jtable/jquery.jtable.js')); ?>" type="text/javascript"></script> */ ?>
		<?php /* <script type="text/javascript" src="<?php echo e(asset('public/js/jquery.jtable.js')); ?>"></script> */ ?>
		<script type="text/javascript" src="<?php echo e(asset('public/js/jquery.jtable.min.js')); ?>"></script>
		<link href="<?php echo e(asset('public/js/themes/lightcolor/green/jtable.css')); ?>" rel="stylesheet" type="text/css" />
		<?php /* <link href="<?php echo e(asset('public/js/themes/lightcolor/blue/jtable.css')); ?>" rel="stylesheet" type="text/css" /> */ ?>
		<?php /* //// */ ?>
